...
::: {#fig-fig4-4 layout-ncol=2 layout-valign="bottom" width=100%}

![](images/fig4-4a.png){#fig-fig4-4a fig-align="left" fig-alt="A bar chart with 48 observations resembles a stair-step pattern with decreasing heights from left to right. The text reads, The mean is the centre of mass of the data. Below the chart, there is a horizontal line labeled balancing point with a triangular fulcrum symbolizing balance."}

![](images/fig4-4b.png){#fig-fig4-4b fig-align="left" fig-alt="The same bar chart with the data split into two groups of 24 observations. The left group is shaded light gray, and the right group is shaded dark gray. An arrow points to the 24th observation with the text The median is the middle observation in the data set."}

An illustration of the difference between how the mean and the median should be interpreted. The mean is basically the 'centre of gravity' of the data set (a). In contrast, the median is the middle observation, with half of the observations smaller and half of the observations larger (b)
:::
